                        ...
                        <div class="p-5 space-y-4">
                            ...
                            <div class="flex justify-center gap-6 pt-3 border-t border-gray-100">
                                <a href="{{ route('book.show', $book->id) }}"
                                    ...
                                    <span class="text-xs font-medium">{{ __('Voir') }}</span>
                                </a>
                                ...
                                <a href="{{ route('book.edit', $book->id) }}"
                                    ...
                                    <span class="text-xs font-medium">{{ __('Modifier') }}</span>
                                </a>
                                ...
                                <form action="{{ route('destroyBook', $book->id) }}" method="POST" class="inline">
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                        onclick="return confirm('{{ __('Êtes-vous sûr de vouloir supprimer ce livre ?') }}')"
                                        ...
                                        <span class="text-xs font-medium">{{ __('Supprimer') }}</span>
                                    </button>
                                </form>
                            </div>
                            @endauth
